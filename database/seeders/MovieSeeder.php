...
class MovieSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        Movie::create([
            ...
            'cover_path' => 'guardians_of_the_galaxy.jpg',
            'director_id' => 4,
            'category_id' => 4,
        ]);
        ...
        Movie::create([
            ...
            'cover_path' => 'captain_america_winter_soldier.jpg',
            'director_id' => 3,
            'category_id' => 4,
        ]);
        ...
        Movie::create([
            ...
            'cover_path' => 'spiderman_homecoming.jpg',
            'director_id' => 1,
            'category_id' => 4,
        ]);
